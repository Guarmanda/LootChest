...
public enum Particle {
	...
	BUBBLE_COLUMN_UP(Mat.BUBBLE_COLUMN, 13),
	BUBBLE_POP(Mat.BUBBLE_COLUMN, 13),
	...
	DRIP_LAVA(Material.LAVA, -1),
	DRIP_WATER(Material.WATER, -1),
	DRIPPING_DRIPSTONE_LAVA(Material.LAVA, 17),
	DRIPPING_DRIPSTONE_WATER(Material.WATER, 17),
	...
	SOUL(Mat.SOUL_FIRE, 16),
	SOUL_FIRE_FLAME(Mat.SOUL_FIRE, 17),
	...
	SUSPENDED_DEPTH(Material.STONE, -1),
	SWEEP_ATTACK(Mat.DIAMOND_SWORD, 9),
	TOTEM(Mat.TOTEM_OF_UNDYING, 11),
	TOWN_AURA(Mat.ENCHANTED_BOOK, -1),
	//VIBRATION(Mat.STONE, 17),
	VILLAGER_ANGRY(Mat.STONE, -1),
	VILLAGER_HAPPY(Mat.STONE, -1),
	WARPED_SPORE(Material.WATER, 16),
	WATER_DROP(Material.WATER, 8),
	WATER_SPLASH(Material.WATER, -1),
	WATER_WAKE(Material.WATER, -1),
	WAX_OFF(Mat.STONE, 17),
	WAX_ON(Mat.STONE, 17),
